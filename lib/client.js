...
var CSS =
  ...
  '.emps-triggerProvider{color:inherit;flex:none;font-weight:400}' +
  ...
  '.emps-cell{box-sizing:border-box;width:auto;min-width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}' +
  '.emps-cell:hover{background:var(--dsw-alias-interactive-bg-hover)}' +
  '.emps-cellLabel{white-space:nowrap;flex:none}' +
  '.emps-cellValue{text-overflow:ellipsis;white-space:nowrap;text-align:right;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}' +
  '.emps-cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}' +
  '.emps-groups{min-height:0;overflow-y:auto}' +
  '.emps-group{margin-top:4px}' +
  '.emps-groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}' +
  '.emps-option{box-sizing:border-box;width:auto;min-width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}' +
  ...
  '.emps-selected{background:0 0}' +
  '.emps-optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}' +
  '.emps-modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}' +
  '.emps-description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}' +
  '.emps-check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}' +
  '.emps-filterBar{padding:4px;border-top:1px solid var(--dsw-alias-border-inverted);display:flex;gap:4px;flex-wrap:wrap;align-items:center;flex:none}' +
...
function EnhancedModelSelect(props) {
  ...
  if (pane === 'model') {
    ...
    if (state.groups.length > 1) {
      ...
      filterBarElement = _react.createElement('div', { className: 'emps-filterBar', key: 'filter' }, fc);
    }
    ...
    if (filterBarElement) menuChildren.push(filterBarElement);
